    ...
    <Container className="my-5">
      ...
      <Form className="p-4 border rounded shadow">
          ...
          <Col md={12}>
            <Form.Group className="mb-3">
              ...
              <FormText className="text-muted">
                Incluye marca, tipo de animal, etapa y cantidad. Ej: “Royal Canin Gato Senior x 1.5kg”
              </FormText>
            </Form.Group>
          </Col>
        </Row>
        ...
        <Row className="mb-3">
          ...
          <Col md={4}>
            <Form.Group>
              ...
              />
              <FormText className="text-muted">
                Número de cuotas sin interés (ej: 3, 6, 12). El valor por cuota se calcula automáticamente.
              </FormText>
            </Form.Group>
          </Col>
        </Row>
        ...
        <Row className="mb-3">
          <Col md={6}>
            <Form.Group>
              ...
              />
              <FormText className="text-muted">
                Valor real del peso del producto (para cálculos internos). Ej: 20.0 (kg) o 0.5 (kg)
              </FormText>
            </Form.Group>
          </Col>
        ...
        <Row className="mb-3">
          <Col md={12}>
            <Form.Group>
              <Form.Label>Descripción Larga (Detalles del Producto)</Form.Label>
              <Form.Control
                as="textarea"
                rows={4}
